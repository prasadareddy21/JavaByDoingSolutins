...
public class FunctionCallAlphabet
{
	public static void main( String[] args )
	{
		...
		f("Siva");    // displays the word you pass it beginning with "F"
		g();    // returns the word to be displayed
		h(5);    // tell it how many times to display the word (1)
		System.out.println();

		i(10);    // pass it any integer and it will display a word beginning with I 
		...
		n( "Silva" );    // displays the word you pass it beginning with "N"
		...
		t("TsaAS" );    // displays the word you pass it beginning with "T"
		u( );    // returns the word to be displayed
		v(4 );    // tell it how many times to display the word (1)
		w(4 );    // pass it any integer and it will display a word beginning with W 
